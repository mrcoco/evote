...
<html>
	<head>
	 <title>Pemilu HMIF 2013 -- vote kahim</title>
	 ...
	 $(document).ready(function () {
		$('#form_kahim_terpilih img').click(function() {

			$('#image-value').val($(this).attr('data-value'));


			$('#form_kahim_terpilih img').removeClass('highlighted');
	...
	<body>
	 <div class="hero-unit">
	  <form name="form_kahim" id="form_kahim_terpilih" action="vote_senator">
		<h2>Vote Calon Ketua Himpunan</h2>
		<p>Silakan memilih calon ketua himpunan dengan melakukan <dfn>click</dfn> pada gambar calon yang sudah disediakan, lalu menekan tombol <dfn>Next</dfn>. Disediakan pilihan golput jika tidak ingin memilih calon ketua himpunan.</p><br></br>
	 <div class="row-fluid">
	  <div class="span12">
	  <?php echo "user id: "; ?>
	  <input type="text" size="32" readonly="true" name="voter_id" value="<?php echo $voter_id; ?>" />
		<div class="row-fluid">
		 ...
		 <input type="hidden" id="image-value" name="vote_cakahim" value="">
		</div>
	  </div>
	 </div>
	 <div align="center">
